...
- DB설계자와 업무담당자(병원관계자)와 협의
    ...
    7. 의사는여러명의 환자를 관찰하고, 환자도 여러 명의 의사에게 진료받을 수 있음
    8. 진료를 받으면 고유진료번호, 진료열이 저장
...
- DB설계자의 개념설계
    - 개체 추출 (병원층수 등 물리적인게 다 들 어갈 필요 없음. 시설관리용이 아님.)
        - 진료과 아래, 키 - 과번호, 속성 - 과이름, 전화번호, 팩스번호 
        - 의사 아래, 키 - 의사번호, 속성 - 이름, 진료과목, 주소, 전화번호, 주민번호, 직급, 과번호, 의사약력
        - 간호사 아래, 키 - 환자번호, 속성 - 이름, 진료과목, 주소, 전화번호, 주민번호, 직급, 과번호
